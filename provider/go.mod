...
require (
	...
	github.com/pulumi/pulumi-terraform-bridge/v2 v2.3.2
...
replace (
	...
	github.com/terraform-providers/terraform-provider-azurerm => github.com/pulumi/terraform-provider-azurerm v1.41.1-0.20200515124722-1dd14455ce64
)
